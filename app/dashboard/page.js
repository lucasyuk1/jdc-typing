...
const isAdmin = user?.username === "larbak" && user?.turma === "ADMIN";
...
<a href="/test" className="btn-auth px-4 py-2">
Fazer Teste
</a>

<a href="/ranking" className="btn-auth px-4 py-2">
Ranking
</a>
...
<a
href="/admin/live"
className="btn-auth px-4 py-2 bg-red-600 hover:bg-red-700"
>
Monitoramento
</a>
)}
