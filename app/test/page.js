...
<div className={`flex-shrink-0 w-32 h-32 md:w-40 md:h-40 transition-all duration-300 ease-in-out transform ${MascoteFade ? "opacity-100 rotate-0" : "opacity-0 -rotate-6"} ${MascoteAnim}`}> <Image src={MascoteAtual} alt="Mascote" width={160} height={160} className="drop-shadow-2xl transition-all duration-300 ease-in-out" /> </div> <div className="text-center md:text-left"> <p className="text-lg">Tempo restante: <b>{`${minutos.toString().padStart(2,"0")}:${segundos.toString().padStart(2,"0")}`}</b></p>
